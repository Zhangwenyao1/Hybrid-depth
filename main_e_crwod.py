...
def main(args):
    ...
    # pretrained_weights = torch.load('/code/occ/CrowdCLIP/results/dummy/version_242/ckpts/epoch=00-val_mae_metric=0.0000.ckpt')
#     pretrained_weights = torch.load('/code/occ/CrowdCLIP/results/dummy/version_245/ckpts/last.ckpt')
#     modified_weights = {}
...
# }
#     torch.save(checkpoint, './modified_weights.ckpt')
  
#     args.basic.from_checkpoint = './modified_weights.ckpt'
    ...
    state_dict = torch.load(args.basic.from_checkpoint)['state_dict']
