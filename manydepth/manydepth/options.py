...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--n_depth_text_tokens", type=int, default=128)
        ...
        self.parser.add_argument("--use_cfmde", action="store_true", default=False)
        self.parser.add_argument("--backbone_model", type=str, default="clip")
        self.parser.add_argument("--debug", action="store_true", default=False)
        self.parser.add_argument("--use_resnet_decoder", action="store_true", default=False)
        self.parser.add_argument("--use_dpt_teacher", action="store_true", default=False)
        ...
        self.parser.add_argument("--no_cost_volume_in_dino", action="store_true", default=True)
        self.parser.add_argument("--only_train_teacher", action="store_true", default=False)
        # PATHS
