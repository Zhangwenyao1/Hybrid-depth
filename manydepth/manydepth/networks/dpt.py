...
from networks.blocks import FeatureFusionBlock, _make_scratch
...
class DPTHead(nn.Module):
    def __init__(self, nclass, in_channels, features=256, use_bn=False, out_channels=[256, 512, 1024], use_clstoken=False):
        ...
        self.projects.append(nn.Conv2d(
            in_channels=512,
            out_channels=1024,
            kernel_size=1,
            stride=1,
