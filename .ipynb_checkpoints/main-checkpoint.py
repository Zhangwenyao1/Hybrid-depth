...
def main(args):
    ...
    pretrained_weights = torch.load('/code/occ/CrowdCLIP/results/dummy/version_75/ckpts/last.ckpt')
    pretrained_weights = torch.load('/code/occ/CrowdCLIP/results/dummy/version_241/ckpts/last.ckpt')
    modified_weights = {}
