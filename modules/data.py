...
class RegressionDataModule(pl.LightningDataModule):
    def __init__(
        ...
        super().__init__()
        self.args = args
        train_data_file = "/data/zhangwenyao/drive_data/TUSimple/process_32_order/train_data/data_list/train.txt"
        train_images_root = "/data/zhangwenyao/drive_data/TUSimple/process_32_order/train_data"
        ...
        val_images_root = test_images_root = "/data/zhangwenyao/drive_data/TUSimple/process_32_order/test_data"
