...
class Trainer:
    def __init__(self, options):
        ...
        if self.opt.depth_model_type == 'depthclip_ed':     
            ...
            self.models["depth"] = networks.depthclipdecoder(self.opt, in_channels=dpt_in_channels, out_channels=[256, 512, 1024, 1024], n_depth_tokens=self.opt.n_depth_text_tokens)
