...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        if opt.use_depth_text_align:
            if opt.cat_depth_text_logic:
                ...
                dpt_in_channels = encoder.lenth
        decoder = networks.depthclipdecoder(opt, in_channels=dpt_in_channels, out_channels=[256, 512, 1024, 1024])
    ...
    # gt_path = os.path.join("/code/CFMDE-main/Stage2/splits/eigen_improved", "gt_depths.npz")
