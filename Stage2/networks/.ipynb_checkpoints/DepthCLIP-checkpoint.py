...
class DepthCLIP(nn.Module):
    ...
    def __init__(self, args):
        ...
        # self.fcaxisangle = nn.Linear(768,3)
        # self.fctranslation = nn.Linear(768,3)
    ...
    def forward(self, image):
        ...
        _, img_f, features = self.clip.encode_image(image)
        # axisangle = self.fcaxisangle(axisangle)
        # axisangle = axisangle.unsqueeze(1).unsqueeze(1)
        # translation = self.fctranslation(translation)
