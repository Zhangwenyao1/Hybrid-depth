...
class DepthCLIP(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.fcaxisangle = nn.Linear(120, 6, bias=True)
        self.conv_axisangle = nn.Conv2d(4096, 1024, 1)
        self.fcaxisangle_linear = nn.Linear(2048, 1024, bias=True)
    ...
    def forward(self, image, pose):
        ...
        # axisangle_bin_tensor = torch.tensor(self.axisangle_bin_centres).to(depth_pred.device)
        
        
        pose = {}
        pose['axisangle_f'] = axisangle_f
        pose['axisangle_txt_f'] = axisangle_txt_f
        # pose['axisangle_bin_tensor'] = axisangle_bin_tensor
        # pose['translation_bin_tensor'] = translation_bin_tensor
        ...
        pose['relu'] = self.relu
        pose['fcaxisangle_linear'] = self.fcaxisangle_linear
