...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--data_path",
                                 ...
                                 default=os.path.join(file_dir, "kitti_dataset_copy/raw"))
                                 # default=os.path.join(file_dir, "nyuvideo/nyu/training"))
                                 
        self.parser.add_argument("--log_dir",
                                 type=str,
                                 help="log directory",
                                 default='/code/depth_estimation/monodepth2/results')
      ...
      #                            default='/code/depth_estimation/monodepth2/basicParams_vit.yaml')
        ...
        self.parser.add_argument("--pose_model_type",
                              ...
                              #    default = 'separate_resnet',
                                 choices=["posecnn", "separate_resnet", "shared", "depthclip_share","depthclip_pose","depthclip_sep_pose"])
